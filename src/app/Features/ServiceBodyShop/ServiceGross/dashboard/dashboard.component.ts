...
export class DashboardComponent implements OnInit {
  ...
  path3: any = "";
  constructor(public apiSrvc: ApiService, private ngbmodal: NgbModal, private ngbmodalActive: NgbActiveModal, private spinner: NgxSpinnerService,private title: Title) {
    this.title.setTitle("XtractSales-ServiceGross");
  ...
  openDetails(Item, ParentItem, ref) {
    ...
    if (ref == '1') {
      if (Item.data1 != undefined && Item.data1 != 'Reports Total') {
        const DetailsServicePerson = this.ngbmodal.open(ServicegrossDetailsComponent, {
          // size:'xl',
          backdrop: "static",
        });
