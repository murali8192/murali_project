...
@Component({
  selector: 'app-sc-reports',
  templateUrl: './sc-reports.component.html',
  styleUrls: ['./sc-reports.component.scss']
})
export class ScReportsComponent implements OnInit {
...
this.scheduleType=[
  {"ST_Name":"Store" ,"status":''},
  {"ST_Name":"Lead Type", "status":''},
  {"ST_Name":"Salesperson Assigned", "status":'Y'},
  {"ST_Name":"Marketing/Campaign", "status":''},
  {"ST_Name":"New/Used", "status":'Y'},
  {"ST_Name":"Make", "status":''},
